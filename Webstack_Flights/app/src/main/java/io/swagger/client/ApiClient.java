...
public class ApiClient {
    ...
    public ApiClient(String[] authNames) {
        ...
        for (String authName : authNames) {
            Interceptor auth;
            if ("TokenHeader".equals(authName)) {
    ...
    public void createDefaultAdapter() {
        ...
        String baseUrl = "https://rethink-webstack-flights.herokuapp.com/api/";
        if (!baseUrl.endsWith("/"))
            baseUrl = baseUrl + "/";
...
//    To create the service for DefaultAPI. Original below.
    public DefaultApi createService() {
